...
const { connection: connectionTrello } = useSignalR(`https://trell-it-withered-fire-570.fly.dev/r/trelloHub`);
const { connection: connectionTrelloLike } = useSignalR(`https://trell-it-withered-fire-570.fly.dev/r/trellolikeHub`);
